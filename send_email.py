...
def main():
    ...
    subject = f"Hansard Alert: {count} Keyword Matches - {transcript_name}"
    ...
    plain_text = create_plain_text_fallback(
        KEYWORDS, count, transcript_name, human_time
    )
    ...
    yag.send(
        to=EMAIL_TO,
        subject=subject,
        contents=[plain_text, html_email],  # yagmail handles HTML/plain multipart
